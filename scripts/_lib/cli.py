"""scripts/_lib/cli.py — shared scaffolding for the `ava-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("ava-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/ava-foo`
...
VERSION = "0.1.0"  # bumped centrally; every ava-* CLI reports this
