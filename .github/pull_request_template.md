...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/ava/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/ava/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses AVA's existing visual language. Specifically:
