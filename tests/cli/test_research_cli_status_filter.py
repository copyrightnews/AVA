"""`ava-research list --status complete` was returning nothing.
...
Part of #2122 (ava-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "ava-research"
    loader = importlib.machinery.SourceFileLoader("ava_research_cli", str(path))
