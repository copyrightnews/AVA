...
INTERNAL_TOOL_TOKEN = os.environ.get("AVA_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-AVA-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-AVA-Internal-Token), or
