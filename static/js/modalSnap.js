...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'ava-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'ava-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('ava:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
