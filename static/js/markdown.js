...
function initMermaid() {
  if (!window.mermaid || window.__avaMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__avaMermaidReady = true;
}
window.avaInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'ava-thinking-expanded';
