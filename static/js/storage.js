...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'ava-model-expanded',
  MODEL_ENDPOINTS: 'ava-model-endpoints',
  MODEL_SELECTED: 'ava-selected-model',
  SORT_ORDER: 'ava-sessions-sort',
  CHAT_SEARCH_SCOPE: 'ava-search-scope',
  INCOGNITO: 'ava-incognito',
  RAG_ACTIVE: 'ava-rag-active',
  MCP_ACTIVE: 'ava-mcp-active',
