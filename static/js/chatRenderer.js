...
const _ACTION_RECENTS_KEY = 'ava-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'ava-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'AVA' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
